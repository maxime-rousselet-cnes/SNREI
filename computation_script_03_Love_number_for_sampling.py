# Computes Love numbers for a single Earth model, but iterates on run description sampling parameters.
#
# See script_01 for details on parameter and result files.

import argparse

from utils import Love_number_comparative_for_sampling
...
if __name__ == "__main__":
    Love_number_comparative_for_sampling(
        initial_real_description_id=args.initial_real_description_id, load_initial_description=args.load_initial_description
    )
