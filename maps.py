...
generate_load_signal_components_figure(
    ...
    anelastic_load_signal_id="48",
    rows=[
        ("initial", None, 50.0, 5.0),
...
generate_load_signal_components_figure(
    ...
    anelastic_load_signal_id="48",
    rows=[
        ("residuals", None, 50.0, 5.0),
        ("residuals", "C_1_0 C_1_1 S_1_1", 5.0, 1.0),
        ("residuals", "C_2_1 S_2_1", 5.0, 1.0),
        # ("continental_leakage", None, 5.0),
        # ("oceanic_leakage", None, 5.0),
    ],
)
