...
def polar_motion_correction(
    ...
    file = open(
        pole_data_path.joinpath(load_signal_hyper_parameters.pole_data + ".txt"), "r"
    )
    ...
    _, frequencies, pole_complex_frequencial_signal, _ = (
    ...
    Phi_SE_PT_complex = (
        PHI_CONSTANT
        * Love_numbers.values[Direction.potential][BoundaryCondition.potential][1]
