...
def plot_anelastic_induced_spatial_load_trend(
    ...
    unit_factor: float = 10,
) -> None:
    """
    Generates figures showing the anelastic induced spatial load signal trend for given description and options:
        - Gets already computed anelastic induced harmonic frequencial load signal.
        - Compute spatial trends.
        - Generates and saves figures (elastic/anelastic/differences) in the specified subfolder.
    """
    _, run_folder_name, run_id, load_signal_harmonic_trends, ocean_means, ocean_mask = (
                get_load_signal_harmonic_trends(
                    do_elastic=True,
