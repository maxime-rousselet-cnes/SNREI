...
def create_all_model_variations(
    ...
    parameters: dict[ModelPart, dict[str, dict[str, list[list[float]]]]] = {
        model_part: {} for model_part in ModelPart
    },
    create: bool = True,
...
def create_load_signal_hyper_parameter_variation(
    ...
    for parameter_tuple in parameter_values:
        setattr(
            load_signal_hyper_parameters, parameter_tuple[0][0], parameter_tuple[0][1]
        )
